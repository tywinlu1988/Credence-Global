...
| L4 财务 | 15% | 毛利率趋势、负债率、现金/短债比、经营性现金流方向、融资能力 | 经营性现金流连续3年以上为负 且 现金跑道 < 6个月 |

**已验证：** 隆基（7.00/BBB+）vs 一道新能（1.50/CCC）— 5.5分区分度

---

### 4.2 半导体/IC（政策驱动型 — 5层金字塔）
...
| L5 财务 | 5-10% | 现金跑道、融资节奏、应收质量、商誉/总资产、关联交易、控股股东质押比 | 商誉/总资产 >20% 且 利息覆盖 < 2x |
...
| L4 财务 | 20% | 调整后毛利率（扣R&D资本化）、真实现金流覆盖、真实杠杆、应收/存货质量 | 必须先做五大会计陷阱修正再分析 |
...
| L4 财务 | 20% / 15%（现金流版） | 现金跑道（月）、烧钱率趋势、BD首付款/里程碑收入、CDMO合同质量、GMP合规 | 现金跑道 < 6个月 |
...
| L4 财务 | 20% | 收入质量（设备 vs 耗材 vs 服务）、医院应收账龄、渠道库存积压、毛利率稳定性 | — |
...
**NEV分析必须使用分离框架：OEM和供应链公司使用不同的金字塔。**
...
| L4 财务 | 15% | 净现金烧钱率、现金跑道（月）、毛利率趋势、隐性负债（经销商返利、质保计提） |
...
| L4 财务 | 17% | 利润稳定性系数、调整后应收周转、降价弹性测试 |
...
| L4 财务 | 30% | 资产收益率/Cap Rate、DSCR、债务期限与资产寿命匹配、维护性资本开支 vs 收入、REIT化可行性 | — |
...
| 半导体/IC | 政策驱动型（特殊：地缘政治-技术混合型） | D3=5 >=4, D4=3 >=3, D7=5 |
