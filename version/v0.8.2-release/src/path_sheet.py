...
sheet），把"角色 × 对象 × 深度 × 数据模式"路由到 engine/work-path-registry.md
...
语义。L0/L1/L2 分层定义见 engine/output-layered-framework.md，SRI 温度计
档位见 engine/systemic-warning-framework.md。
"""
