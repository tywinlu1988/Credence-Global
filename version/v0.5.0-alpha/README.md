...
/
├── README.md                                          ← 你在这里
├── industry-validation-report.html                     8行业验证报告（Tab分页）
│
├── product/                                           → 产品设计
...
│
├── cases/                                             → 验证案例
│   ├── solar-longi-yidao/                            光伏前瞻（隆基 vs 一道新能）
│   ├── yongmei/                                      永煤回溯（双时点·17个月）
│   ├── tsinghua-unigroup/                            紫光回溯（半导体·17个月）
│   ├── brilliance-auto/                              华晨回溯（三身份·22个月）
│   └── pv-credit-dashboard/                          光伏信用债仪表盘
│
...
| 想了解... | 去看... |
|---|---|
| 8行业完整验证结果 | `industry-validation-report.html` |
