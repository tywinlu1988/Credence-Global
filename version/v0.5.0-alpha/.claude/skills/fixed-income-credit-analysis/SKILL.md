...
| M2 | Bond Underwriting (DCM) | Can we sell this? To whom? Best window? | P1 Planned |
| M3 | Market Trading | Rate/credit/liquidity environment? | P1 Planned |
| M4 | Portfolio Risk | Concentration? Stress scenario? | P2 Planned |
| M5 | Corporate Finance | How to finance? Which channel? When? | P2 Planned |
...
|---|---|---|
| Solar/PV | Longi (7.00) vs Yidao (1.50) | — |
| Semiconductor | — | Tsinghua Unigroup (17-month) |
| Biomedicine | — | — |
| High-End Equipment | — | — |
| Medical Devices | — | — |
| NEV | — | — |
| Data Center | — | — |
| Coal/SOE | — | Yongmei (17-month, 2 time points) |
