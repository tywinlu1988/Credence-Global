...
| 2 | 半导体/集成电路 | **范式A** [政策驱动型](industry-framework.md) + **范式B** [技术壁垒型](industry-framework.md) | 双重属性：政策资金驱动+技术壁垒·国产替代主线·资本开支巨大 | 高 | 中等(大基金/国资背景) |
| 3 | 高端装备/工业母机 | **范式B** [技术壁垒型](industry-framework.md) | 技术密集型·客户定制化·进口替代逻辑·周期性与政策关联 | 中等 | 中等(部分央企) |
| 4 | 生物医药/创新药 | **范式B** [技术壁垒型](industry-framework.md) | 研发驱动·管线价值决定信用·融资依赖IPO/私募·高不确定性 | 中高 | 低(民企为主) |
...
| 范式 | 纳入行业 | 范式内传染特征 |
|------|---------|---------------|
| **范式A** ([政策驱动型](industry-framework.md)) | 光伏/储能、半导体/集成电路 | 政策转向同步冲击·产能周期共振·融资环境同频 |
| **范式B** ([技术壁垒型](industry-framework.md)) | 半导体/集成电路、高端装备、生物医药、医疗器械 | 供应链紧密·技术路线迭代风险·IPO融资渠道共振 |
