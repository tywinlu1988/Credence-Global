...
**Version `v0.3.2`** ([changelog](CHANGELOG.md)) · **30 methodology documents** · **16 work paths** · **4 coded engines** · pytest regression suite + consistency gates (CI: Ubuntu & Windows) · 🌐 English
