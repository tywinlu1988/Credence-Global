...
**Version `v0.0.9`** ([changelog](CHANGELOG.md)) · **27 methodology documents** · **16 work paths** · **4 coded engines** · pytest regression suite + consistency gates (CI: Ubuntu & Windows) · 🌐 English
