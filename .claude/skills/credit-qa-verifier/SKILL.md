...
- **Chain compliance**: A Path Sheet exists for the `path_id`, and this QA Verdict is produced before delivery — no analysis ships without it. Rule source: `${CLAUDE_PLUGIN_ROOT}/engine/pipeline-contract.md`.
