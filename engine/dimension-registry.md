...
dimensions:
  - id: paradigm-P1
    name: Cyclical
    letter: P1
    definition: Cyclical (${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md §3)
    standalone_doc: embedded in ${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md §3 (determination) and §4 (pyramid weights)
  ...
  - id: paradigm-P2
    name: Defensive
    letter: P2
    definition: Defensive (${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md §3)
    standalone_doc: embedded in ${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md §3 (determination) and §4 (pyramid weights) + application note ${CLAUDE_PLUGIN_ROOT}/engine/paradigm-brand-channel.md
  ...
  - id: paradigm-P3
    name: Growth
    letter: P3
    definition: Growth (${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md §3)
    standalone_doc: embedded in ${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md §3 (determination) and §4 (pyramid weights)
  ...
  - id: paradigm-P4
    ...
    letter: P4
    definition: Regulated Utility (${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md §3)
    standalone_doc: embedded in ${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md §3 (determination) and §4 (pyramid weights) + application note ${CLAUDE_PLUGIN_ROOT}/engine/paradigm-network-traffic.md (network/throughput lens)
  ...
  - id: paradigm-P5
    name: Financial
    letter: P5
    definition: Financial (${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md §3)
    standalone_doc: embedded in ${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md §3 (determination) and §4 (pyramid weights) + dedicated framework ${CLAUDE_PLUGIN_ROOT}/engine/financial-bond-framework.md
  ...
  - id: paradigm-P6
    ...
    letter: P6
    definition: Sovereign-Linked (${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md §3)
    standalone_doc: embedded in ${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md §3 (determination) and §4 (pyramid weights) + dedicated framework ${CLAUDE_PLUGIN_ROOT}/engine/external-support-framework.md
...
roles:
  - id: role-credit-selector
    ...
    definition: Credit Selector (${CLAUDE_PLUGIN_ROOT}/engine/multi-stakeholder.md §1)
    used_by_paths: [WP-CS-01, WP-CS-02]

  - id: role-portfolio-manager
    name: Portfolio Manager
    definition: Portfolio Manager (${CLAUDE_PLUGIN_ROOT}/engine/multi-stakeholder.md §1)
    used_by_paths: [WP-PM-01, WP-PM-02]

  - id: role-advisor
    name: Advisor
    definition: Advisor (${CLAUDE_PLUGIN_ROOT}/engine/multi-stakeholder.md §1)
    used_by_paths: [WP-AD-01]

  - id: role-trader
    name: Trader
    definition: Trader (${CLAUDE_PLUGIN_ROOT}/engine/multi-stakeholder.md §1)
    used_by_paths: [WP-TR-01]

  - id: role-risk-officer
    name: Risk Officer
    definition: Risk Officer (${CLAUDE_PLUGIN_ROOT}/engine/multi-stakeholder.md §1)
    used_by_paths: [WP-RO-01, WP-RO-02, WP-RO-03, WP-RO-04]

  - id: role-individual-investor
    name: Individual Investor
    definition: Individual Investor (${CLAUDE_PLUGIN_ROOT}/engine/multi-stakeholder.md §1)
