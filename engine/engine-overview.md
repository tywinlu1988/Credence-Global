...
|---|---|---|---|
| **Layer 1** | Mosaic Engine (Mode A) | Extract signals from unstructured public data, assemble, assess completeness | Implemented (v0.1.0) |
...
| **Layer 4** | System Intelligence Layer (Aggregation) *NEW | Contagion mapping, concentration dashboard, early warning thermometer; cross-industry and cross-issuer systemic risk perception | Implemented (v0.1.0) |
...
|---|---|---|---|
| **Engine Version** | Core methodology documents | v0.1.0 | Reflects the overall iteration stage of engine methodology; all core methodology documents are uniformly labeled with this version |
...
|---|---|---|
| engine-overview.md | v0.1.0 | Engine architecture overview |
| dual-track-methodology.md | v0.1.0 | Dual-track analysis methodology |
| industry-framework.md | v0.1.0 | Industry classification and analysis framework |
| qualitative-analysis.md | v0.1.0 | Qualitative analysis methodology |
| quantitative-analysis.md | v0.1.0 | Quantitative analysis methodology |
| mosaic-engine.md | v0.1.0 | Mosaic engine |
| output-layered-framework.md | v0.1.0 | Layered output framework |
| contagion-theory.md | v0.1.0 | Contagion theory foundations (System Intelligence Layer) |
| contagion-matrix.md | v0.1.0 | 19-industry contagion matrix |
| concentration-framework.md | v0.1.0 | 5-dimension concentration analysis framework |
| systemic-warning-framework.md | v0.1.0 | Systemic early warning framework |
| validation-methodology.md | v0.1.0 | Black swan backtesting validation methodology |
| financial-bond-framework.md | v0.1.0 | Financial bond analysis framework |
| holding-company-framework.md | v0.1.0 | Holding company credit analysis framework |
| non-credit-risk-overlay.md | v0.1.0 | Non-credit risk overlay |
| external-support-framework.md | v0.1.0 | External support assessment framework |
| esg-framework.md | v0.1.0 | ESG and governance risk framework |
| governance-fraud-risk.md | v0.1.0 | Governance and fraud risk framework |
| outlook-monitoring-framework.md | v0.1.0 | Outlook and ongoing monitoring framework |
| lgd-recovery-framework.md | v0.1.0 | LGD and recovery analysis framework |
| multi-stakeholder.md | v0.1.0 | Multi-stakeholder framework |
| financial-deep-dive.md | v0.1.0 | Financial deep dive analysis framework |
| paradigm-brand-channel.md | v0.1.0 | Brand + channel paradigm specification |
| paradigm-network-traffic.md | v0.1.0 | Network + traffic paradigm specification |
| work-path-registry.md | v0.1.0 | Work path registry |
| dimension-registry.md | v0.1.0 | Dimension registry |
| pipeline-contract.md | v0.1.0 | Four-stage pipeline product contracts |
