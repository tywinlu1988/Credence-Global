...
1. `${CLAUDE_PLUGIN_ROOT}/engine/outlook-monitoring-framework.md` — trigger factors, scoring, watchlist, migration matrix (single source for all rule values)
...
- `${CLAUDE_PLUGIN_ROOT}/templates/template-type18.html` — Outlook Monitoring
