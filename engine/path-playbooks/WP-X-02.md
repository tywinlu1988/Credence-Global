...
1. `${CLAUDE_PLUGIN_ROOT}/engine/multi-stakeholder.md` — role definitions (§1), role deep-dives (§2), cross-role matrix (§3), five-step parallel process (§4)
2. `${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md` — per-role underlying analysis basis
