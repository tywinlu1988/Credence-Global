...
1. `${CLAUDE_PLUGIN_ROOT}/engine/systemic-warning-framework.md` — the entire definition of this path
...
- `${CLAUDE_PLUGIN_ROOT}/templates/template-type15.html` — SRI Thermometer
