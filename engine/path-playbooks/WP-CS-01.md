...
1. `${CLAUDE_PLUGIN_ROOT}/engine/industry-framework.md` §§1-5 — paradigm determination, pyramid, veto
2. `${CLAUDE_PLUGIN_ROOT}/engine/mosaic-engine.md` §§1-6 — signal extraction, completeness, density rules, Mode B guardrail
