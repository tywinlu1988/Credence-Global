...
1. `${CLAUDE_PLUGIN_ROOT}/engine/contagion-matrix.md` — the 19x19 matrix, clusters, escalation rules (single source for all matrix values)
2. `${CLAUDE_PLUGIN_ROOT}/engine/contagion-theory.md` — contagion types and transmission pathways
...
- `${CLAUDE_PLUGIN_ROOT}/templates/template-type13.html` — Contagion Map
...
- `Escalation Factor (${CLAUDE_PLUGIN_ROOT}/engine/contagion-matrix.md §6)`
