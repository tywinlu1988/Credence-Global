...
1. `${CLAUDE_PLUGIN_ROOT}/engine/esg-framework.md` — ESG scoring dimensions, environmental/social/governance factors (§1), red-flag triggers
2. `${CLAUDE_PLUGIN_ROOT}/engine/governance-fraud-risk.md` — financial fraud red flags (§1), earnings management and manipulation signals (§4)
