...
| 系统智能报告 | 9份（⭐标记） | 传染复盘4份 + 集中度情景3份 + 系统性警报1份 + 其他 |
...
| **v0.7.0-release** | **2026-07-10** | **系统智能层发布：传染图谱（4份复盘+13×13矩阵+Type 13）·集中度仪表盘（五维框架+3份情景+Type 14）·系统性预警（SRI温度计+Type 15）。引擎架构升级至四层。M4组合风控完整实现。13行业全量覆盖。L0温度计卡片。15种报告模板体系。** |
