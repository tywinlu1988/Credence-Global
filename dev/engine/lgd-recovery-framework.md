...
**Version**: v0.3.2 | **Date**: 2026-07-17 | **Status**: Published
...
> international frameworks) live in `appendix/lgd-recovery-framework-appendix.md`
> — read on demand.
...
- [Appendix (moved sections, on-demand)](appendix/lgd-recovery-framework-appendix.md)
...
> **Appendix**: §§4-6 (assessment process, priority, collateral valuation), §10 (international bankruptcy), §11 (international collateral standards) moved to `appendix/lgd-recovery-framework-appendix.md` — read on demand.
