...
**Version**: v0.2.0 | **Date**: 2026-07-10 | **Positioning**: On top of dual-track static ratings, add forward-looking direction and continuous monitoring mechanisms
...
The current engine (v0.2.0) outputs a **static snapshot rating** (AAA through D) that only reflects the credit quality assessment at the time of analysis. Beyond static ratings, professional rating agencies consistently maintain **three time dimensions**:
...
> §§4-5 (continuous-monitoring triggers, migration matrices) are required for
> the monitoring path. §6-9 (integration, output specs, reliability, appendices)
> live in `appendix/outlook-monitoring-framework-appendix.md` — read on demand.
...
> **Calibration note (v0.2.0):** This matrix was calibrated on China credit-bond market
...
> **Appendix**: §6 (integration), §7 (reliability under public data), output specifications, appendices moved to `appendix/outlook-monitoring-framework-appendix.md` — read on demand.
