...
**Version**: v0.0.9 | **Date**: 2026-07-10 | **Positioning**: On top of dual-track static ratings, add forward-looking direction and continuous monitoring mechanisms
...
The current engine (v0.0.9) outputs a **static snapshot rating** (AAA through D) that only reflects the credit quality assessment at the time of analysis. Beyond static ratings, professional rating agencies consistently maintain **three time dimensions**:
...
> §§4-5 contain worked examples, derivations, historical validation, and
...
> **Calibration note (v0.0.9):** This matrix was calibrated on China credit-bond market
