...
> **Reading guide**: §§1-3 (three-tier overview, L0 Signal Card spec), §§4-6
> (L1/L2 specs, priority sorting), and §8 (integration, lamp caliber) contain
> the executable core — required reading before executing any work path that
> references this document.
> §7, §§9-10 (workflow embedding, special states, appendices) live in
> `appendix/output-layered-framework-appendix.md` — read on demand.
...
> **Appendix**: §7 (workflow embedding), §9 (special states), §10 (appendices) moved to `appendix/output-layered-framework-appendix.md` — read on demand.
