...
> reconciliation) live in `appendix/financial-deep-dive-appendix.md` — read on demand.
...
- [Appendix (moved sections, on-demand)](appendix/financial-deep-dive-appendix.md)
...
> **Appendix**: §F (sovereign-specific metrics), §G (bank CAMELS), Appendix (IFRS/US GAAP reconciliation) moved to `appendix/financial-deep-dive-appendix.md` — read on demand.
