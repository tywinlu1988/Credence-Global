...
1. `dev/engine/output-layered-framework.md` — L0 Signal Card specification (§3), signal priority scoring, information tiers
2. `dev/engine/systemic-warning-framework.md` — SRI four-tier thermometer (§3), signal aggregation, escalation trigger definitions
