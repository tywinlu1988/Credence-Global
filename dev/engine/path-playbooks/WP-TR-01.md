...
1. `dev/engine/output-layered-framework.md` §§1-3 — L0 Signal Card specification (§3), three-tier overview; §6 — information priority sorting rules
2. `dev/engine/systemic-warning-framework.md` §§1-4 — SRI four-tier thermometer (§3), signal aggregation, escalation trigger definitions
