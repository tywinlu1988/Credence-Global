...
1. `dev/engine/industry-framework.md` §§1-5 — D1-D10, paradigms, determination logic, pyramids, veto
2. `dev/engine/mosaic-engine.md` §§1-6 — completeness and density rules
