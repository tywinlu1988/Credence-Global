...
1. `dev/engine/advisor-origination-framework.md` — issuance window (three-dimension), investor matching (five-segment), comparable pricing (five-factor adjustment)
