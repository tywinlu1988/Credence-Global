...
**Version**: v0.2.0 | **Date**: 2026-07-17 | **Status**: Internationalized (Phase 2)
...
> scoring framework, industry pyramids, and veto mechanism — required reading
> before executing any work path that references this document.
> Appendices A-C (per-paradigm score definitions, summary matrix, legacy
> comparison) live in `appendix/industry-framework-appendix.md` — read on demand.
...
> **Appendix**: Appendices A-C (per-paradigm score definitions, summary matrix, legacy comparison) moved to `appendix/industry-framework-appendix.md` — read on demand.
