...
> `appendix/validation-methodology-appendix.md` — read on demand.
...
> **Appendix**: §6 (completed case summaries), §7 (key findings and improvement record) moved to `appendix/validation-methodology-appendix.md` — read on demand.
