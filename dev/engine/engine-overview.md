...
|---|---|---|---|
| **Layer 1** | Mosaic Engine (Mode A) | Extract signals from unstructured public data, assemble, assess completeness | Implemented (v0.1.1) |
| **Layer 2** | Dual-Track Analysis (Track A + B) | Fundamental pyramid scoring + market pricing signal cross-validation | Implemented (v0.1.1) |
...
| **Layer 4** | System Intelligence Layer (Aggregation) *NEW | Contagion mapping, concentration dashboard, early warning thermometer; cross-industry and cross-issuer systemic risk perception | Implemented (v0.1.1) |
...
|---|---|---|---|
| **Engine Version** | Core methodology documents | v0.1.1 | Reflects the overall iteration stage of engine methodology; all core methodology documents are uniformly labeled with this version |
...
|---|---|---|
| engine-overview.md | v0.1.1 | Engine architecture overview |
| dual-track-methodology.md | v0.1.1 | Dual-track analysis methodology |
| industry-framework.md | v0.1.1 | Industry classification and analysis framework |
| qualitative-analysis.md | v0.1.1 | Qualitative analysis methodology |
| quantitative-analysis.md | v0.1.1 | Quantitative analysis methodology |
| mosaic-engine.md | v0.1.1 | Mosaic engine |
| output-layered-framework.md | v0.1.1 | Layered output framework |
| contagion-theory.md | v0.1.1 | Contagion theory foundations (System Intelligence Layer) |
| contagion-matrix.md | v0.1.1 | 19-industry contagion matrix |
| concentration-framework.md | v0.1.1 | 5-dimension concentration analysis framework |
| systemic-warning-framework.md | v0.1.1 | Systemic early warning framework |
| validation-methodology.md | v0.1.1 | Black swan backtesting validation methodology |
| financial-bond-framework.md | v0.1.1 | Financial bond analysis framework |
| holding-company-framework.md | v0.1.1 | Holding company credit analysis framework |
| non-credit-risk-overlay.md | v0.1.1 | Non-credit risk overlay |
| external-support-framework.md | v0.1.1 | External support assessment framework |
| esg-framework.md | v0.1.1 | ESG and governance risk framework |
| governance-fraud-risk.md | v0.1.1 | Governance and fraud risk framework |
...
| work-path-registry.md | v0.1.1 | Work path registry |
| dimension-registry.md | v0.1.1 | Dimension registry |
| pipeline-contract.md | v0.1.1 | Four-stage pipeline product contracts |
