...
**Version**: v0.3.0 | **Date**: 2026-07-10 | **Status**: Released
...
> limitations) live in `appendix/systemic-warning-framework-appendix.md` — read
> only when the analysis needs detailed justification.


- [Appendix (moved sections, on-demand)](appendix/systemic-warning-framework-appendix.md)
...
> **Appendix**: §§5-8 (historical backtests, current-period example), §9 (threshold sensitivity), §11 (limitations), §12 Appendices B-C moved to `appendix/systemic-warning-framework-appendix.md` — read on demand.
...
*This document should be used in conjunction with the Dual-Track Methodology (v0.3.0), Contagion Matrix (v0.3.0), Five-Dimensional Concentration Analysis Framework (v0.3.0), and Outlook Monitoring Framework. The Systemic Warning Framework is the top-level dashboard for the engine's M4 Portfolio Risk Control Layer, providing a unified systemic risk reading for dispersed industry signals.*