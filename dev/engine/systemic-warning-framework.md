...
**Version**: v0.2.0 | **Date**: 2026-07-10 | **Status**: Released
...
*This document should be used in conjunction with the Dual-Track Methodology (v0.2.0), Contagion Matrix (v0.2.0), Five-Dimensional Concentration Analysis Framework (v0.2.0), and Outlook Monitoring Framework. The Systemic Warning Framework is the top-level dashboard for the engine's M4 Portfolio Risk Control Layer, providing a unified systemic risk reading for dispersed industry signals.*