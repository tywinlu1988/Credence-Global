...
quality_gates:
  - "Five-Tier LGD Classification (dev/engine/lgd-recovery-framework.md §2)"
...
quality_gates:
  - "Forward-Looking Comparison Method (dev/engine/validation-methodology.md §4)"
  - "Comparative Assessment Results (dev/engine/validation-methodology.md §4.3)"
```
...
depth: special
engine_sequence:
  - dev/engine/advisor-origination-framework.md
...
depth: special
engine_sequence:
  - dev/engine/financing-channel-framework.md
...
quality_gates:
  - "Channel Comparison (dev/engine/financing-channel-framework.md §3)"
  - "Timing Assessment (dev/engine/financing-channel-framework.md §4)"
```
...
quality_gates:
  ...
  - "Financial Fraud Red Flag Checklist (dev/engine/governance-fraud-risk.md §1)"
  - "Earnings Management and Manipulation Signals (dev/engine/governance-fraud-risk.md §4)"
```
