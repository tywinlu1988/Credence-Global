...
> §§10-11 and the Appendix live in `appendix/concentration-framework-appendix.md`
> — read on demand.


- [Appendix (moved sections, on-demand)](appendix/concentration-framework-appendix.md)
## 1. Design Overview
...
> **Cross-document consumption note:** When the Concentration Framework references the Contagion Matrix, it only consumes each cell's **`intensity`** and **`direction`** fields, used to identify contagion strength and determine uni/bidirectional relationships. The `type`, `confidence`, and `historical_cases` fields do not enter the quantitative calculation in the current v0.3.0.
...
> **Appendix**: §10 (integration), §11 (limitations), Appendix moved to `appendix/concentration-framework-appendix.md` — read on demand.