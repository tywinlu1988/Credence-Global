...
根据《传染理论基础》(v0.6.1-alpha)定义的6种分析范式，将13个行业映射至对应范式。同一范式内的行业因共享相同的风险驱动因子、融资特征和市场叙事逻辑，**先天性具有更高的传染耦合度**。
...
*本文档是《传染理论基础》(v0.6.1-alpha)的操作化延伸，两者需配合使用。*
