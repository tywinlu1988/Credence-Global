...
**Version**: v0.3.0 | **Date**: 2026-07-17
...
> §§7-10 (trap signals, integration notes, limitations) live in
> `appendix/external-support-framework-appendix.md` — read on demand.
...
> **Appendix**: §7 (trap signals), §8 (integration), §9 (usage guide), §10 (limitations) moved to `appendix/external-support-framework-appendix.md` — read on demand.
