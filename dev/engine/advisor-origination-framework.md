...
**Version**: v0.3.2 | **Date**: 2026-07-29 | **Status**: Published
...
- **Issuance Window (dev/engine/advisor-origination-framework.md §2)** — three-dimension window assessment with sub-indicator scoring and refinancing-urgency override
- **Investor Matching (dev/engine/advisor-origination-framework.md §3)** — five-segment investor matching with ESG exclusion overlay
- **Comparable Pricing (dev/engine/advisor-origination-framework.md §4)** — 3-5 comparable selection, five-factor pricing adjustment, asymmetric range
...
- [Quantitative Analysis](reference/quantitative-analysis.md) — §7.4 issuance rate changes (market repricing signals)
