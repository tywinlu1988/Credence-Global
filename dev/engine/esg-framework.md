...
**Version**: v0.3.0 | **Date**: 2026-07-10 | **Status**: Published | **Type**: Non-Credit Risk Overlay Sub-Module
...
> encounter. §6 contains the overlay adjustment rules.
> §7, §8, and Appendices A-B live in `appendix/esg-framework-appendix.md`
> — read on demand.
...
- [Appendix (moved sections, on-demand)](appendix/esg-framework-appendix.md)
...
> **Appendix**: §7 (data availability labeling), §8 (integration), Appendices A-B moved to `appendix/esg-framework-appendix.md` — read on demand.
