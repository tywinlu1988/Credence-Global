...
**Version**: v0.1.1 | **Date**: 2026-07-31 | **Status**: Published
...
- **Execution Dimensions (dev/engine/trader-framework.md §2)** — all four dimensions
  scored or gap-declared; weights 35/25/25/15 applied; data-gap rule honored
- **Execution Decision Matrix (dev/engine/trader-framework.md §5)** — matrix row
