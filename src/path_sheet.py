...
work-path in ${CLAUDE_PLUGIN_ROOT}/engine/work-path-registry.md. This module is the machine-readable
...
L0/L1/L2 layering definitions are in ${CLAUDE_PLUGIN_ROOT}/engine/output-layered-framework.md; SRI
thermometer bands are in ${CLAUDE_PLUGIN_ROOT}/engine/systemic-warning-framework.md.
"""
...
def _strip_plugin_prefix(p: str) -> str:
    ...
    The dist package rewrites `${CLAUDE_PLUGIN_ROOT}/engine/` and `${CLAUDE_PLUGIN_ROOT}/templates/` to
